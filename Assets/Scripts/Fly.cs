...
public class Fly : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            case "Bullet":
                animatior.SetBool("Fly Take Damage", true);
    ...
    {
        rigid.velocity = new Vector2(Movementf_Speed * Time.fixedDeltaTime, rigid.velocity.y);
    }
    ...
    {
        Player_Health--;
        animatior.SetBool("Fly Take Damage", false);
        if (Player_Health <= 0)
        {
